...
class ProductController extends Controller
{
    ...
    public function edit($id)
    {
        try {
            ...
            $parentCategries = $this->categoryRepository->getIdParents();
            $subCategries = $this->categoryRepository->getIdFirstSubCategories($product->category->parentCategory->id);

            return view('admin.product.edit', compact('product', 'parentCategries', 'subCategries'));
        } catch (Exception $e) {
            return view('templates.admin.404');
        }
    }
