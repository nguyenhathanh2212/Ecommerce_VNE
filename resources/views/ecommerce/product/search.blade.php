        ...
        <div class="row">
            <div class="col-xs-12">
                <ul>
                    ...
                    <li>
                        <strong>@lang('lang.search')</strong>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-main col-sm-12 col-xs-12">
                <div class="shop-inner">
                    <div class="page-title">
                        ...
                        <span>{{ $products->total() }} @lang('lang.itemsFoundBy') '{{ $text }}'</span>
                    </div>
                                                    ...
                                                    <div class="product-thumbnail">
                                                        ...
                                                        <div class="pr-img-area">
                                                            <a href="{{ route('ecommerce.product.show', [$product->id]) }}">
                                                                {{ Html::image(asset($product->first_picture), '', ['class' => 'first-img', 'height' => '350']) }}
                                                                {{ Html::image(asset($product->first_picture), '', ['class' => 'hover-img', 'height' => '350']) }}
                                                            </a>
